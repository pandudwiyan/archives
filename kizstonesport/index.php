            ...
            <div class="row">
                ...
                <div class="col-12">
                    <ul class="product-tab-nav nav justify-content-center mb-10 title-border-bottom mt-n3">
                        <li class="nav-item" data-aos="fade-up" data-aos-delay="300"><a class="nav-link active mt-3" data-bs-toggle="tab" href="#tab-product-all"><?= $nama_perusahaan." Collection"?></a></li>
                    </ul>
                </div>
                <!-- Tab End -->
            </div>
                        ...
                        <div class="product-summery">
                            ...
                            <div class="cart-wishlist-btn pb-4 mb-n3" style="float:right;">
                                ...
                                <div class="add-to-wishlist mb-3">
                                    <a href="checkout" class="btn btn-outline-dark btn-hover-primary" onclick="add_to_cart();">Checkout</a>
                                </div>
                            </div>
